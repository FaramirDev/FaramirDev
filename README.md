...
- **Gestion des Workflows pipelines Techniques** (optimisation, versionning).
...
- ![crowdsec console](./icone/bouclier-verifie_extra_low.png)  **Cybersécurité** (audits, durcissement de systèmes, bonnes pratiques ANSSI)
- ![crowdsec console](./icone/bouclier-verifie_extra_low.png)  **Automatisation** (Ansible, PowerShell, scripts Python)
...
| **Outils & Méthodes**              | Git, GLPI, Nagios, VirtualBox, VMWARE,Wireshark, Nmap, WordPress, NGINX, Mysql, TLS                                 |
...
|------------------------------------------------------------------------|--------------------------------------------------|--------------------------------------------------------------------------------------|
| **[Projet 9 : Infra Automatisation & Securty - Barzini](https://github.com/FaramirDev/Projet_09_Infra_Barzini)**  | Serveur Active-Directory, Serveur Linux - Ansible, Service Veeam Backup, Service Cryptomator, Powershell, Yaml, Python, Automatisation                 |  Infrastructure du Studio Barzini, Automatisation d'un Parc Hybrid Win & Linux, Politique de Sauvegarde Veeam Backup, Audit de Securtie.                   |
