...
Ma force réside dans ma capacité à coupler une culture **Développement** avec une gestion rigoureuse des **Infrastructures Systèmes et Réseaux**. J'approche chaque projet sur le modele **Zero Trust** & le principe du **moindre privilège** couplé a une philosophie "**Automation & Security by Design**". 
...
### 📂 [Projet Sentinel-NetPulse : Audit Scan Network Vulnerability sous Python - Linux ](https://github.com/FaramirDev/Projet-Audit-Network-Scanner-Linux)
